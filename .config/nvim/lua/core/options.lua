...
opt.foldexpr = "v:lua.require('core.utils').ui.foldexpr()" -- Fold expressions
...
opt.signcolumn = 'yes' -- Always show the sign column (for diagnostics, etc.), otherwise it would shift the text each time
...
opt.scrolloff = 10 -- Keeps 10 lines visible while scrolling
opt.sidescrolloff = 10 -- Keeps 10 columns visible while scrolling
